...
class GameController extends AbstractController
{
    ...
    public function delete(Request $request, Game $game, GameRepository $gameRepository, ResultController $resultController, ResultRepository $resultRepository): Response
    {
        $resultController->delete($request, $game, $resultRepository);
